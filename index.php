...
?>
     ...
     foreach ($resultSet as $row) {
        ...
        echo "<div class='sp w3-quarter w3-card w3-center ' ><div class='w3-orange w3-padding-large'>$iStatus</div><div ><img onclick=\"document.getElementById('$iName').style.display='block'\" id='testimg' src='./images/". $iImage . "'  width='200px', height= '200px'></div><div class='name'><h3>$iName</h3></div><h3>$iPrice$</h3></div>"
  ...
  <div id='$iName' class='w3-modal'>
      <div class='w3-modal-content w3-animate-top w3-card-4'>
        ...
        <div class='w3-container w3-row'>
          <div class='w3-half'>
              <img src='./images/". $iImage . "' width='50%'>
          </div>
...
?>
    ...
    $query = "SELECT iid, iname, idescription, iprice, istatus, isize, iimage,cname FROM item,catalogue WHERE item.cid=catalogue.cid AND cName LIKE '%Nike%'  ORDER BY cname";
     ...
     foreach ($resultSet as $row) {
        ...
        echo "<div class='sp w3-quarter w3-card w3-center ' ><div class='w3-pink w3-padding-large'>$iStatus</div><div ><img onclick=\"document.getElementById('$iName').style.display='block'\" id='testimg' src='./images/". $iImage . "' width='200px', height='200px'></div><div class='name'><h3>$iName</h3></div><h3>$iPrice$</h3></div>"
                . "<!--SHOW MORE INFORMATION-->
  <div id='$iName' class='w3-modal'>
      <div class='w3-modal-content w3-animate-top w3-card-4'>
